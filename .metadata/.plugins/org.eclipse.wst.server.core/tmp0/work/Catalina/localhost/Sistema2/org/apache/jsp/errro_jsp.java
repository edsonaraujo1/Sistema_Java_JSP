 ...
 * Generated at: 2013-03-17 23:02:21 UTC
...
public final class errro_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String w_bomdia = situa_1 + " Seja Bem Vindo, " + w_nome3 + " hoje e, " + new java.text.SimpleDateFormat("EEEE dd 'de' MMMM 'de' yyyy").format(new java.util.Date()) + "<br />";
 ...
 out.println(w_versaox); 
      ...
      out.write("\t\t <font color = #FF0000>&nbsp;&nbsp; ERRO ACESSO NÃO PERMITIDO !!!</font></b><br>\r\n");
      out.write("\t\t\t\t\t\t\t   &nbsp;&nbsp;Seu computador não tem permissão,<br>\r\n");
      out.write("\t\t\t\t\t\t\t   &nbsp;&nbsp;para uso na <b>");
 out.println(w_SEMA); 
      out.write("</b>, caso<br>\r\n");
      out.write("\t\t\t\t\t\t\t   &nbsp;&nbsp;seja nessessario entre em contato com o<br>\r\n");
      out.write("\t\t\t\t\t\t\t   <b>ADMINISTRADOR DO SISTEMA<br>\r\n");
      out.write("\t\t\t\t\t\t\t</b>\r\n");
